...
namespace Gems.Http.Samples.Metrics.GlobalOverride.PingPong.GetPongQuery;

[Endpoint("api/v1/samples/{secret}/pong", "GET", OperationGroup = "Samples", Summary = "Возращает pong.")]
